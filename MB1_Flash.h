 ...
 * @version 1.0
 * @date 8-12-2013
 * @brief This is header file for MB1_Flash.
 * Format of Flash:
...
public:
    ...
    MB1_flash_ns::status_t open (const char *fileName, const char *fileDesc, MB1_flash_ns::mode_t mode);
    MB1_flash_ns::status_t open (MB1_flash_ns::mode_t mode);
    MB1_flash_ns::status_t close (void);

    /**< extra function */
    void fileInfo_write (MB1_flash_ns::fileInfo_s &aStruct); //TODO
    void fileInfo_read (MB1_flash_ns::fileInfo_s &aStruct); //TODO
    /**< extra function */
    ...
    void seekp (int64_t offset, MB1_flash_ns::direction_t direction);
    void seekg (int64_t offset, MB1_flash_ns::direction_t direction);

    void flush (void);

private:
    uint8_t pageBuffer[MB1_flash_ns::pageLen];
    uint32_t putPosition, getPosition, position_max;

    /**< errcode */
    MB1_flash_ns::status_t errcode;
    ...
    MB1_flash_ns::status_t buffer_writeToPage (void);
    MB1_flash_ns::status_t buffer_readFromPage (uint32_t pageAddr);

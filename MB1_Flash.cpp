 ...
 * @version 1.0
 * @date 8-12-2013
 * @brief This is source file for MB1_Flash.
 *
 * Format of Flash:
 * MB1_flash_headerAddr
 *         |
 * |---- 16 ----|------- 128 -------|--- 4 -----|--- 4 -----|---- 104 ------|-- vary ---|
...
using namespace MB1_flash_ns;

/**
 * @brief MB1_flash constructor. Init private vars.
 ...
 * @param MB1_flash_ns::mode_t mode : mode to open file.
 * @return MB1_flash_ns::status_t
 ...
 */
MB1_flash_ns::status_t MB1_flash::open (const char *fileName, const char *fileDesc, MB1_flash_ns::mode_t mode){
    /**< declare some vars */
 ...
 * app mode have not been implemented yet
 */
MB1_flash_ns::status_t MB1_flash::open (MB1_flash_ns::mode_t mode){
    /**< check CR flag */
 ...
 * @return void
 */
MB1_flash_ns::status_t MB1_flash::close(void){
 ...
 * @return uint32_t
 */
void MB1_flash::seekp(uint32_t position){
 ...
 * @param MB1_flash_ns::direction_t direction, can be one of following values:
 ...
 * @return uint32_t
 */
void MB1_flash::seekp(int64_t offset, MB1_flash_ns::direction_t direction){
    uint32_t position;
    int64_t positionInt;
 ...
 * @return uint32_t
 */
void MB1_flash::seekg (uint32_t position){
    /**< check if file is open or not */
    if ( (!file_isOpen) || (!binaryFlag) )
        return;
 ...
 * @return void.
 */
void MB1_flash::seekg(int64_t offset, MB1_flash_ns::direction_t direction){
    uint32_t position;
    int64_t positionInt;
    bool isOkayToSeek = false;
 ...
 * hard fault.
 */
uint32_t MB1_flash::write (uint8_t *memblock, uint32_t len){
 ...
 * real flash page.
 */
uint32_t MB1_flash::read (uint8_t *memblock, uint32_t len){
    uint16_t aCount;
 ...
 */
void MB1_flash::dataLen_write (uint32_t dataLen){
 ...
 * @return uint32_t
 */
uint32_t MB1_flash::dataLen_read (void){
    uint32_t retVal;
    uint16_t aCount;
 ...
 * buffer_readFromPage.
 */
MB1_flash_ns::status_t MB1_flash::buffer_writeToPage (void){
    /**< declare vars */
    uint16_t aCount;
 ...
 */
status_t MB1_flash::buffer_readFromPage (uint32_t pageAddr){
    /**< declare vars */
    uint16_t aCount;
 ...
 * @return uint8_t
 */
uint8_t MB1_flash::byte_read (uint32_t startAddr){
    /**< check condition */
